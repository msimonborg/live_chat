defmodule LiveChat.RoomsTest do
  ...
  describe "rooms" do
    ...
    test "create_room/1 with valid data creates a room" do
      valid_attrs = %{created_by: "some created_by", description: "some description", name: "some name"}
    ...
    test "update_room/2 with valid data updates the room" do
      room = room_fixture()
      update_attrs = %{created_by: "some updated created_by", description: "some updated description", name: "some updated name"}
